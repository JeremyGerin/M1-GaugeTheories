...
Pour $p\in P$ et $v\in T_pP$ alors on note $w = w^H + w^V$ où $w^H \in \Hor(T_pP)$ et $w^V \in \Verti(T_pP)$ dans la somme directe associée à la connexion d'Ehresmann $\omega$.
