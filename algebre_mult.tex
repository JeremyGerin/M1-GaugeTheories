...
\begin{rem}
De la même façon dont on identifie $E^*\otimes F^*$ avec les formes bilinéaires sur $E\times F$, on identifie $\otimes^k V^*$ avec les formes $k$-linéaires sur $V^k$ et on identifie $\Lambda^k V^*$ avec les formes $k$-linéaires alternées sur $V^k$. De plus, on identifie également $\otimes^k V^* \otimes F$ avec les applications $k$-linéaire $V^k \to F$ et $\Lambda^k V^* \otimes F$ avec les application $k$-linéaire alternées $V^k \to F$. \\
